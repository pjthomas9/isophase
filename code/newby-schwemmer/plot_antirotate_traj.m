...
u = -omega*y + gamma*x.*(1-x.^2-y.^2) + c*gamma*y.*(-omega*(1-sqrt(x.^2+y.^2))^2);
v = omega*x + gamma*y.*(1-x.^2-y.^2) - c*gamma*x.*(-omega*(1-sqrt(x.^2+y.^2))^2);
